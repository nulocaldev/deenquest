    ...
    <div className="min-h-screen frosted-bg">
      ...
      <main className="pt-32 pb-20 px-6 space-y-12">
        <div className="max-w-6xl mx-auto">
          ...
          <section className="mb-12">
            <SponsorCard 
              title="Deepen Your Spiritual Reflection"
              description="Discover Islamic books, journals, and guided reflection resources to enhance your spiritual journey"
              ctaText="Explore Resources"
              onCtaClick={() => console.log('Sponsor CTA clicked')}
            />
          </section>
