...
interface Message {
  ...
  sender: "user" | "ai";
  timestamp: Date;
  type?: "welcome" | "wisdom" | "achievement" | "sponsor";
}
...
const mockSponsor = {
  ...
  description: "Empowering Muslims through knowledge and community since 1995",
  type: "mission-aligned" as const,
  location: "Global",
  website: "https://example.com",
  specialOffer: "Free 30-day trial of premium Islamic courses",
  contextMessage: "Continue your learning journey with trusted Islamic education"
};
...
export default function ChatFirstHomepage() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Occasionally show sponsor after AI response
      if (Math.random() > 0.7) {
        setTimeout(() => {
