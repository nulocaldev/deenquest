...
export default function CardsPage() {
  ...
  const mockSponsor = {
    ...
    description: "Expand your Islamic knowledge with authentic books and resources",
    type: "lifestyle" as const,
    location: "Online",
    website: "https://example.com",
    specialOffer: "20% off all Islamic books this month",
    contextMessage: "Deepen your understanding with authentic Islamic literature"
  };
          ...
          <TabsContent value="collection" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCards.map((card, index) => (
                <div key={index}>
                  <HikmahCard {...card} />
                  {/* Show sponsor card occasionally */}
                  {index === 2 && (
                    <div className="mt-6">
                      <SponsorCard 
                        sponsor={mockSponsor} 
