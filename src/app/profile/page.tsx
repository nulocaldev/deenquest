      ...
      <header className="sticky top-0 z-50 w-full ios-blur">
        <div className="container flex h-20 items-center justify-between px-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-aurora-cyan to-aurora-purple bg-clip-text text-transparent">
                User Profile
              </h1>
          ...
          <CardContent className="p-8">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="relative">
                <div className="w-24 h-24 rounded-full bg-gradient-to-r from-aurora-purple to-aurora-pink flex items-center justify-center">
